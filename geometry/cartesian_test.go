...
func TestIsCollinearTo(t *testing.T) {
	p1, p2, p3, p4 := Point{X: 1.0, Y: 1.0}, Point{X: 2.0, Y: 2.0}, Point{X: -3.5, Y: -3.5}, Point{X: 95.46352, Y: 95.463521}
	if !p1.CollinearTo(p2, p3, p4) {
		t.Fatalf("12")
	}
	p5, p6, p7, p8 := Point{X: -1.0, Y: 1.0}, Point{X: -2.0, Y: 2.0}, Point{X: 3.5, Y: -3.5}, Point{X: -95.46352, Y: 95.463521}
...
func TestInsidePolygon(t *testing.T) {
	...
	antiOrigin := Point{X: -0.0, Y: -0.0}

	p1, p2, p3 := Point{X: 1.0, Y: 0.0}, Point{X: 0.0, Y: 1.0}, Point{X: -1.0, Y: -1.0}
	...
	p4, p5, p6 := Point{X: 0.0, Y: 1.0}, Point{X: -2.0, Y: -2.0}, Point{X: -3.0, Y: -2.0}
	if origin.InsidePolygon(p4, p5, p6) {
		t.Fatalf("40")
	}
	v, b, f := Point{X: -449.397, Y: -219.1855}, Point{X: -415.823, Y: -1956.295}, Point{X: 642.788, Y: 766.040}
